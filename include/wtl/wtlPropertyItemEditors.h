#ifndef CCWTL_PROPERTYITEMEDITORS__H
#define CCWTL_PROPERTYITEMEDITORS__H
...
public:
    ...
    CPropertyEditWindow() : m_fCancel( false ) {} // empty
...
public:
    ...
    CPropertyComboWindow()
        : m_wndList( this, 2 ), m_hWndCombo( NULL ), m_cyList( 0 )
    {
    }
