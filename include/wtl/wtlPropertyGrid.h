#ifndef CCWTL_PROPERTYGRID__H
#define CCWTL_PROPERTYGRID__H
...
public:
   ...
   // Implementation
    ...
    bool _IsValidInplace() const
    {
        return (m_iInplaceRow != -1) && (m_iInplaceCol != -1) && ::IsWindow( m_hwndInplace );
    }
    ...
    LRESULT OnLButtonDown( UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/ )
    {
        ...
        else
        {
            ...
            // Let owner know
            NMPROPERTYITEM nmh = { m_hWnd, static_cast<UINT_PTR>(GetDlgCtrlID()), PIN_SELCHANGED, NULL };
